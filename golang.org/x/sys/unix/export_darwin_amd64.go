...
func init() {
	igop.RegisterPackage(&igop.Package{
		...
		NamedTypes: map[string]reflect.Type{
			...
			"CtlInfo":              reflect.TypeOf((*q.CtlInfo)(nil)).Elem(),
			"Dirent":               reflect.TypeOf((*q.Dirent)(nil)).Elem(),
			"Eproc":                reflect.TypeOf((*q.Eproc)(nil)).Elem(),
			"ExternProc":           reflect.TypeOf((*q.ExternProc)(nil)).Elem(),
			...
			"IfreqMTU":             reflect.TypeOf((*q.IfreqMTU)(nil)).Elem(),
			...
			"Itimerval":            reflect.TypeOf((*q.Itimerval)(nil)).Elem(),
			"Kevent_t":             reflect.TypeOf((*q.Kevent_t)(nil)).Elem(),
			"KinfoProc":            reflect.TypeOf((*q.KinfoProc)(nil)).Elem(),
			...
			"Pcred":                reflect.TypeOf((*q.Pcred)(nil)).Elem(),
			...
			"RawSockaddrCtl":       reflect.TypeOf((*q.RawSockaddrCtl)(nil)).Elem(),
			...
			"RawSockaddrVM":        reflect.TypeOf((*q.RawSockaddrVM)(nil)).Elem(),
			...
			"SockaddrCtl":          reflect.TypeOf((*q.SockaddrCtl)(nil)).Elem(),
			...
			"SockaddrVM":           reflect.TypeOf((*q.SockaddrVM)(nil)).Elem(),
			...
			"SysvIpcPerm":          reflect.TypeOf((*q.SysvIpcPerm)(nil)).Elem(),
			"SysvShmDesc":          reflect.TypeOf((*q.SysvShmDesc)(nil)).Elem(),
			"TCPConnectionInfo":    reflect.TypeOf((*q.TCPConnectionInfo)(nil)).Elem(),
			...
			"Vmspace":              reflect.TypeOf((*q.Vmspace)(nil)).Elem(),
			"WaitStatus":           reflect.TypeOf((*q.WaitStatus)(nil)).Elem(),
			"Winsize":              reflect.TypeOf((*q.Winsize)(nil)).Elem(),
			"XSockbuf":             reflect.TypeOf((*q.XSockbuf)(nil)).Elem(),
			"XSocket":              reflect.TypeOf((*q.XSocket)(nil)).Elem(),
			"XSocket64":            reflect.TypeOf((*q.XSocket64)(nil)).Elem(),
			"XVSockPCB":            reflect.TypeOf((*q.XVSockPCB)(nil)).Elem(),
			"XVSockPgen":           reflect.TypeOf((*q.XVSockPgen)(nil)).Elem(),
		...
		Funcs: map[string]reflect.Value{
			...
			"ClockGettime":                reflect.ValueOf(q.ClockGettime),
			"Clonefile":                   reflect.ValueOf(q.Clonefile),
			"Clonefileat":                 reflect.ValueOf(q.Clonefileat),
			...
			"Fclonefileat":                reflect.ValueOf(q.Fclonefileat),
			"FcntlFlock":                  reflect.ValueOf(q.FcntlFlock),
			"FcntlFstore":                 reflect.ValueOf(q.FcntlFstore),
			...
			"GetsockoptTCPConnectionInfo": reflect.ValueOf(q.GetsockoptTCPConnectionInfo),
			...
			"IoctlCtlInfo":                reflect.ValueOf(q.IoctlCtlInfo),
			"IoctlGetIfreqMTU":            reflect.ValueOf(q.IoctlGetIfreqMTU),
			...
			"IoctlSetIfreqMTU":            reflect.ValueOf(q.IoctlSetIfreqMTU),
			...
			"SysctlKinfoProc":             reflect.ValueOf(q.SysctlKinfoProc),
			"SysctlKinfoProcSlice":        reflect.ValueOf(q.SysctlKinfoProcSlice),
			...
			"SysvShmAttach":               reflect.ValueOf(q.SysvShmAttach),
			"SysvShmCtl":                  reflect.ValueOf(q.SysvShmCtl),
			"SysvShmDetach":               reflect.ValueOf(q.SysvShmDetach),
			"SysvShmGet":                  reflect.ValueOf(q.SysvShmGet),
		...
		UntypedConsts: map[string]igop.UntypedConst{
			...
			"AF_SYS_CONTROL":                    {"untyped int", constant.MakeInt64(int64(q.AF_SYS_CONTROL))},
			...
			"ATTR_BIT_MAP_COUNT":                {"untyped int", constant.MakeInt64(int64(q.ATTR_BIT_MAP_COUNT))},
			"ATTR_CMN_ACCESSMASK":               {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_ACCESSMASK))},
			"ATTR_CMN_ACCTIME":                  {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_ACCTIME))},
			"ATTR_CMN_ADDEDTIME":                {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_ADDEDTIME))},
			"ATTR_CMN_BKUPTIME":                 {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_BKUPTIME))},
			"ATTR_CMN_CHGTIME":                  {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_CHGTIME))},
			"ATTR_CMN_CRTIME":                   {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_CRTIME))},
			"ATTR_CMN_DATA_PROTECT_FLAGS":       {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_DATA_PROTECT_FLAGS))},
			"ATTR_CMN_DEVID":                    {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_DEVID))},
			"ATTR_CMN_DOCUMENT_ID":              {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_DOCUMENT_ID))},
			"ATTR_CMN_ERROR":                    {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_ERROR))},
			"ATTR_CMN_EXTENDED_SECURITY":        {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_EXTENDED_SECURITY))},
			"ATTR_CMN_FILEID":                   {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_FILEID))},
			"ATTR_CMN_FLAGS":                    {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_FLAGS))},
			"ATTR_CMN_FNDRINFO":                 {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_FNDRINFO))},
			"ATTR_CMN_FSID":                     {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_FSID))},
			"ATTR_CMN_FULLPATH":                 {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_FULLPATH))},
			"ATTR_CMN_GEN_COUNT":                {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_GEN_COUNT))},
			"ATTR_CMN_GRPID":                    {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_GRPID))},
			"ATTR_CMN_GRPUUID":                  {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_GRPUUID))},
			"ATTR_CMN_MODTIME":                  {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_MODTIME))},
			"ATTR_CMN_NAME":                     {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_NAME))},
			"ATTR_CMN_NAMEDATTRCOUNT":           {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_NAMEDATTRCOUNT))},
			"ATTR_CMN_NAMEDATTRLIST":            {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_NAMEDATTRLIST))},
			"ATTR_CMN_OBJID":                    {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_OBJID))},
			"ATTR_CMN_OBJPERMANENTID":           {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_OBJPERMANENTID))},
			"ATTR_CMN_OBJTAG":                   {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_OBJTAG))},
			"ATTR_CMN_OBJTYPE":                  {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_OBJTYPE))},
			"ATTR_CMN_OWNERID":                  {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_OWNERID))},
			"ATTR_CMN_PARENTID":                 {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_PARENTID))},
			"ATTR_CMN_PAROBJID":                 {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_PAROBJID))},
			"ATTR_CMN_RETURNED_ATTRS":           {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_RETURNED_ATTRS))},
			"ATTR_CMN_SCRIPT":                   {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_SCRIPT))},
			"ATTR_CMN_SETMASK":                  {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_SETMASK))},
			"ATTR_CMN_USERACCESS":               {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_USERACCESS))},
			"ATTR_CMN_UUID":                     {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_UUID))},
			"ATTR_CMN_VALIDMASK":                {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_VALIDMASK))},
			"ATTR_CMN_VOLSETMASK":               {"untyped int", constant.MakeInt64(int64(q.ATTR_CMN_VOLSETMASK))},
			"ATTR_FILE_ALLOCSIZE":               {"untyped int", constant.MakeInt64(int64(q.ATTR_FILE_ALLOCSIZE))},
			"ATTR_FILE_CLUMPSIZE":               {"untyped int", constant.MakeInt64(int64(q.ATTR_FILE_CLUMPSIZE))},
			"ATTR_FILE_DATAALLOCSIZE":           {"untyped int", constant.MakeInt64(int64(q.ATTR_FILE_DATAALLOCSIZE))},
			"ATTR_FILE_DATAEXTENTS":             {"untyped int", constant.MakeInt64(int64(q.ATTR_FILE_DATAEXTENTS))},
			"ATTR_FILE_DATALENGTH":              {"untyped int", constant.MakeInt64(int64(q.ATTR_FILE_DATALENGTH))},
			"ATTR_FILE_DEVTYPE":                 {"untyped int", constant.MakeInt64(int64(q.ATTR_FILE_DEVTYPE))},
			"ATTR_FILE_FILETYPE":                {"untyped int", constant.MakeInt64(int64(q.ATTR_FILE_FILETYPE))},
			"ATTR_FILE_FORKCOUNT":               {"untyped int", constant.MakeInt64(int64(q.ATTR_FILE_FORKCOUNT))},
			"ATTR_FILE_FORKLIST":                {"untyped int", constant.MakeInt64(int64(q.ATTR_FILE_FORKLIST))},
			"ATTR_FILE_IOBLOCKSIZE":             {"untyped int", constant.MakeInt64(int64(q.ATTR_FILE_IOBLOCKSIZE))},
			"ATTR_FILE_LINKCOUNT":               {"untyped int", constant.MakeInt64(int64(q.ATTR_FILE_LINKCOUNT))},
			"ATTR_FILE_RSRCALLOCSIZE":           {"untyped int", constant.MakeInt64(int64(q.ATTR_FILE_RSRCALLOCSIZE))},
			"ATTR_FILE_RSRCEXTENTS":             {"untyped int", constant.MakeInt64(int64(q.ATTR_FILE_RSRCEXTENTS))},
			"ATTR_FILE_RSRCLENGTH":              {"untyped int", constant.MakeInt64(int64(q.ATTR_FILE_RSRCLENGTH))},
			"ATTR_FILE_SETMASK":                 {"untyped int", constant.MakeInt64(int64(q.ATTR_FILE_SETMASK))},
			"ATTR_FILE_TOTALSIZE":               {"untyped int", constant.MakeInt64(int64(q.ATTR_FILE_TOTALSIZE))},
			"ATTR_FILE_VALIDMASK":               {"untyped int", constant.MakeInt64(int64(q.ATTR_FILE_VALIDMASK))},
			"ATTR_VOL_ALLOCATIONCLUMP":          {"untyped int", constant.MakeInt64(int64(q.ATTR_VOL_ALLOCATIONCLUMP))},
			"ATTR_VOL_ATTRIBUTES":               {"untyped int", constant.MakeInt64(int64(q.ATTR_VOL_ATTRIBUTES))},
			"ATTR_VOL_CAPABILITIES":             {"untyped int", constant.MakeInt64(int64(q.ATTR_VOL_CAPABILITIES))},
			"ATTR_VOL_DIRCOUNT":                 {"untyped int", constant.MakeInt64(int64(q.ATTR_VOL_DIRCOUNT))},
			"ATTR_VOL_ENCODINGSUSED":            {"untyped int", constant.MakeInt64(int64(q.ATTR_VOL_ENCODINGSUSED))},
			"ATTR_VOL_FILECOUNT":                {"untyped int", constant.MakeInt64(int64(q.ATTR_VOL_FILECOUNT))},
			"ATTR_VOL_FSTYPE":                   {"untyped int", constant.MakeInt64(int64(q.ATTR_VOL_FSTYPE))},
			"ATTR_VOL_INFO":                     {"untyped int", constant.MakeInt64(int64(q.ATTR_VOL_INFO))},
			"ATTR_VOL_IOBLOCKSIZE":              {"untyped int", constant.MakeInt64(int64(q.ATTR_VOL_IOBLOCKSIZE))},
			"ATTR_VOL_MAXOBJCOUNT":              {"untyped int", constant.MakeInt64(int64(q.ATTR_VOL_MAXOBJCOUNT))},
			"ATTR_VOL_MINALLOCATION":            {"untyped int", constant.MakeInt64(int64(q.ATTR_VOL_MINALLOCATION))},
			"ATTR_VOL_MOUNTEDDEVICE":            {"untyped int", constant.MakeInt64(int64(q.ATTR_VOL_MOUNTEDDEVICE))},
			"ATTR_VOL_MOUNTFLAGS":               {"untyped int", constant.MakeInt64(int64(q.ATTR_VOL_MOUNTFLAGS))},
			"ATTR_VOL_MOUNTPOINT":               {"untyped int", constant.MakeInt64(int64(q.ATTR_VOL_MOUNTPOINT))},
			"ATTR_VOL_NAME":                     {"untyped int", constant.MakeInt64(int64(q.ATTR_VOL_NAME))},
			"ATTR_VOL_OBJCOUNT":                 {"untyped int", constant.MakeInt64(int64(q.ATTR_VOL_OBJCOUNT))},
			"ATTR_VOL_QUOTA_SIZE":               {"untyped int", constant.MakeInt64(int64(q.ATTR_VOL_QUOTA_SIZE))},
			"ATTR_VOL_RESERVED_SIZE":            {"untyped int", constant.MakeInt64(int64(q.ATTR_VOL_RESERVED_SIZE))},
			"ATTR_VOL_SETMASK":                  {"untyped int", constant.MakeInt64(int64(q.ATTR_VOL_SETMASK))},
			"ATTR_VOL_SIGNATURE":                {"untyped int", constant.MakeInt64(int64(q.ATTR_VOL_SIGNATURE))},
			"ATTR_VOL_SIZE":                     {"untyped int", constant.MakeInt64(int64(q.ATTR_VOL_SIZE))},
			"ATTR_VOL_SPACEAVAIL":               {"untyped int", constant.MakeInt64(int64(q.ATTR_VOL_SPACEAVAIL))},
			"ATTR_VOL_SPACEFREE":                {"untyped int", constant.MakeInt64(int64(q.ATTR_VOL_SPACEFREE))},
			"ATTR_VOL_SPACEUSED":                {"untyped int", constant.MakeInt64(int64(q.ATTR_VOL_SPACEUSED))},
			"ATTR_VOL_UUID":                     {"untyped int", constant.MakeInt64(int64(q.ATTR_VOL_UUID))},
			"ATTR_VOL_VALIDMASK":                {"untyped int", constant.MakeInt64(int64(q.ATTR_VOL_VALIDMASK))},
			...
			"BS0":                               {"untyped int", constant.MakeInt64(int64(q.BS0))},
			"BS1":                               {"untyped int", constant.MakeInt64(int64(q.BS1))},
			"BSDLY":                             {"untyped int", constant.MakeInt64(int64(q.BSDLY))},
			...
			"CLOCK_MONOTONIC_RAW":               {"untyped int", constant.MakeInt64(int64(q.CLOCK_MONOTONIC_RAW))},
			"CLOCK_MONOTONIC_RAW_APPROX":        {"untyped int", constant.MakeInt64(int64(q.CLOCK_MONOTONIC_RAW_APPROX))},
			...
			"CLOCK_UPTIME_RAW":                  {"untyped int", constant.MakeInt64(int64(q.CLOCK_UPTIME_RAW))},
			"CLOCK_UPTIME_RAW_APPROX":           {"untyped int", constant.MakeInt64(int64(q.CLOCK_UPTIME_RAW_APPROX))},
			"CLONE_NOFOLLOW":                    {"untyped int", constant.MakeInt64(int64(q.CLONE_NOFOLLOW))},
			"CLONE_NOOWNERCOPY":                 {"untyped int", constant.MakeInt64(int64(q.CLONE_NOOWNERCOPY))},
			"CR0":                               {"untyped int", constant.MakeInt64(int64(q.CR0))},
			"CR1":                               {"untyped int", constant.MakeInt64(int64(q.CR1))},
			"CR2":                               {"untyped int", constant.MakeInt64(int64(q.CR2))},
			"CR3":                               {"untyped int", constant.MakeInt64(int64(q.CR3))},
			"CRDLY":                             {"untyped int", constant.MakeInt64(int64(q.CRDLY))},
			...
			"CTLIOCGINFO":                       {"untyped int", constant.MakeInt64(int64(q.CTLIOCGINFO))},
			...
			"EV_DISPATCH2":                      {"untyped int", constant.MakeInt64(int64(q.EV_DISPATCH2))},
			...
			"EV_UDATA_SPECIFIC":                 {"untyped int", constant.MakeInt64(int64(q.EV_UDATA_SPECIFIC))},
			"EV_VANISHED":                       {"untyped int", constant.MakeInt64(int64(q.EV_VANISHED))},
			...
			"FF0":                               {"untyped int", constant.MakeInt64(int64(q.FF0))},
			"FF1":                               {"untyped int", constant.MakeInt64(int64(q.FF1))},
			"FFDLY":                             {"untyped int", constant.MakeInt64(int64(q.FFDLY))},
			"FLUSHO":                            {"untyped int", constant.MakeInt64(int64(q.FLUSHO))},
			"FSOPT_ATTR_CMN_EXTENDED":           {"untyped int", constant.MakeInt64(int64(q.FSOPT_ATTR_CMN_EXTENDED))},
			"FSOPT_NOFOLLOW":                    {"untyped int", constant.MakeInt64(int64(q.FSOPT_NOFOLLOW))},
			"FSOPT_NOINMEMUPDATE":               {"untyped int", constant.MakeInt64(int64(q.FSOPT_NOINMEMUPDATE))},
			"FSOPT_PACK_INVAL_ATTRS":            {"untyped int", constant.MakeInt64(int64(q.FSOPT_PACK_INVAL_ATTRS))},
			"FSOPT_REPORT_FULLSIZE":             {"untyped int", constant.MakeInt64(int64(q.FSOPT_REPORT_FULLSIZE))},
			"FSOPT_RETURN_REALDEV":              {"untyped int", constant.MakeInt64(int64(q.FSOPT_RETURN_REALDEV))},
			"F_ADDFILESIGS":                     {"untyped int", constant.MakeInt64(int64(q.F_ADDFILESIGS))},
			"F_ADDFILESIGS_FOR_DYLD_SIM":        {"untyped int", constant.MakeInt64(int64(q.F_ADDFILESIGS_FOR_DYLD_SIM))},
			"F_ADDFILESIGS_INFO":                {"untyped int", constant.MakeInt64(int64(q.F_ADDFILESIGS_INFO))},
			"F_ADDFILESIGS_RETURN":              {"untyped int", constant.MakeInt64(int64(q.F_ADDFILESIGS_RETURN))},
			"F_ADDFILESUPPL":                    {"untyped int", constant.MakeInt64(int64(q.F_ADDFILESUPPL))},
			...
			"F_BARRIERFSYNC":                    {"untyped int", constant.MakeInt64(int64(q.F_BARRIERFSYNC))},
			"F_CHECK_LV":                        {"untyped int", constant.MakeInt64(int64(q.F_CHECK_LV))},
			...
			"F_GETPATH_NOFIRMLINK":              {"untyped int", constant.MakeInt64(int64(q.F_GETPATH_NOFIRMLINK))},
			...
			"F_GETSIGSINFO":                     {"untyped int", constant.MakeInt64(int64(q.F_GETSIGSINFO))},
			...
			"F_PUNCHHOLE":                       {"untyped int", constant.MakeInt64(int64(q.F_PUNCHHOLE))},
			...
			"F_SPECULATIVE_READ":                {"untyped int", constant.MakeInt64(int64(q.F_SPECULATIVE_READ))},
			...
			"F_TRIM_ACTIVE_FILE":                {"untyped int", constant.MakeInt64(int64(q.F_TRIM_ACTIVE_FILE))},
			...
			"IFT_6LOWPAN":                       {"untyped int", constant.MakeInt64(int64(q.IFT_6LOWPAN))},
			...
			"IFT_PKTAP":                         {"untyped int", constant.MakeInt64(int64(q.IFT_PKTAP))},
			...
			"IOCTL_VM_SOCKETS_GET_LOCAL_CID":    {"untyped int", constant.MakeInt64(int64(q.IOCTL_VM_SOCKETS_GET_LOCAL_CID))},
			"IPC_CREAT":                         {"untyped int", constant.MakeInt64(int64(q.IPC_CREAT))},
			"IPC_EXCL":                          {"untyped int", constant.MakeInt64(int64(q.IPC_EXCL))},
			"IPC_NOWAIT":                        {"untyped int", constant.MakeInt64(int64(q.IPC_NOWAIT))},
			"IPC_PRIVATE":                       {"untyped int", constant.MakeInt64(int64(q.IPC_PRIVATE))},
			"IPC_RMID":                          {"untyped int", constant.MakeInt64(int64(q.IPC_RMID))},
			"IPC_SET":                           {"untyped int", constant.MakeInt64(int64(q.IPC_SET))},
			"IPC_STAT":                          {"untyped int", constant.MakeInt64(int64(q.IPC_STAT))},
			...
			"IPV6_3542DSTOPTS":                  {"untyped int", constant.MakeInt64(int64(q.IPV6_3542DSTOPTS))},
			"IPV6_3542HOPLIMIT":                 {"untyped int", constant.MakeInt64(int64(q.IPV6_3542HOPLIMIT))},
			"IPV6_3542HOPOPTS":                  {"untyped int", constant.MakeInt64(int64(q.IPV6_3542HOPOPTS))},
			"IPV6_3542NEXTHOP":                  {"untyped int", constant.MakeInt64(int64(q.IPV6_3542NEXTHOP))},
			"IPV6_3542PKTINFO":                  {"untyped int", constant.MakeInt64(int64(q.IPV6_3542PKTINFO))},
			"IPV6_3542RTHDR":                    {"untyped int", constant.MakeInt64(int64(q.IPV6_3542RTHDR))},
			"IPV6_ADDR_MC_FLAGS_PREFIX":         {"untyped int", constant.MakeInt64(int64(q.IPV6_ADDR_MC_FLAGS_PREFIX))},
			"IPV6_ADDR_MC_FLAGS_TRANSIENT":      {"untyped int", constant.MakeInt64(int64(q.IPV6_ADDR_MC_FLAGS_TRANSIENT))},
			"IPV6_ADDR_MC_FLAGS_UNICAST_BASED":  {"untyped int", constant.MakeInt64(int64(q.IPV6_ADDR_MC_FLAGS_UNICAST_BASED))},
			...
			"IPV6_FLOW_ECN_MASK":                {"untyped int", constant.MakeInt64(int64(q.IPV6_FLOW_ECN_MASK))},
			...
			"LOCAL_PEEREPID":                    {"untyped int", constant.MakeInt64(int64(q.LOCAL_PEEREPID))},
			"LOCAL_PEEREUUID":                   {"untyped int", constant.MakeInt64(int64(q.LOCAL_PEEREUUID))},
			"LOCAL_PEERPID":                     {"untyped int", constant.MakeInt64(int64(q.LOCAL_PEERPID))},
			"LOCAL_PEERTOKEN":                   {"untyped int", constant.MakeInt64(int64(q.LOCAL_PEERTOKEN))},
			"LOCAL_PEERUUID":                    {"untyped int", constant.MakeInt64(int64(q.LOCAL_PEERUUID))},
			...
			"MAP_RESILIENT_CODESIGN":            {"untyped int", constant.MakeInt64(int64(q.MAP_RESILIENT_CODESIGN))},
			"MAP_RESILIENT_MEDIA":               {"untyped int", constant.MakeInt64(int64(q.MAP_RESILIENT_MEDIA))},
			"MAP_SHARED":                        {"untyped int", constant.MakeInt64(int64(q.MAP_SHARED))},
			"MAP_TRANSLATED_ALLOW_EXECUTE":      {"untyped int", constant.MakeInt64(int64(q.MAP_TRANSLATED_ALLOW_EXECUTE))},
			"MAP_UNIX03":                        {"untyped int", constant.MakeInt64(int64(q.MAP_UNIX03))},
			...
			"MNT_CPROTECT":                      {"untyped int", constant.MakeInt64(int64(q.MNT_CPROTECT))},
			"MNT_DEFWRITE":                      {"untyped int", constant.MakeInt64(int64(q.MNT_DEFWRITE))},
			"MNT_DONTBROWSE":                    {"untyped int", constant.MakeInt64(int64(q.MNT_DONTBROWSE))},
			"MNT_DOVOLFS":                       {"untyped int", constant.MakeInt64(int64(q.MNT_DOVOLFS))},
			"MNT_DWAIT":                         {"untyped int", constant.MakeInt64(int64(q.MNT_DWAIT))},
			"MNT_EXPORTED":                      {"untyped int", constant.MakeInt64(int64(q.MNT_EXPORTED))},
			"MNT_EXT_ROOT_DATA_VOL":             {"untyped int", constant.MakeInt64(int64(q.MNT_EXT_ROOT_DATA_VOL))},
			"MNT_FORCE":                         {"untyped int", constant.MakeInt64(int64(q.MNT_FORCE))},
			"MNT_IGNORE_OWNERSHIP":              {"untyped int", constant.MakeInt64(int64(q.MNT_IGNORE_OWNERSHIP))},
			"MNT_JOURNALED":                     {"untyped int", constant.MakeInt64(int64(q.MNT_JOURNALED))},
			...
			"MNT_NOBLOCK":                       {"untyped int", constant.MakeInt64(int64(q.MNT_NOBLOCK))},
			"MNT_NODEV":                         {"untyped int", constant.MakeInt64(int64(q.MNT_NODEV))},
			"MNT_NOEXEC":                        {"untyped int", constant.MakeInt64(int64(q.MNT_NOEXEC))},
			"MNT_NOSUID":                        {"untyped int", constant.MakeInt64(int64(q.MNT_NOSUID))},
			"MNT_NOUSERXATTR":                   {"untyped int", constant.MakeInt64(int64(q.MNT_NOUSERXATTR))},
			"MNT_NOWAIT":                        {"untyped int", constant.MakeInt64(int64(q.MNT_NOWAIT))},
			"MNT_QUARANTINE":                    {"untyped int", constant.MakeInt64(int64(q.MNT_QUARANTINE))},
			...
			"MNT_REMOVABLE":                     {"untyped int", constant.MakeInt64(int64(q.MNT_REMOVABLE))},
			...
			"MNT_STRICTATIME":                   {"untyped int", constant.MakeInt64(int64(q.MNT_STRICTATIME))},
			...
			"MNT_UNKNOWNPERMISSIONS":            {"untyped int", constant.MakeInt64(int64(q.MNT_UNKNOWNPERMISSIONS))},
			...
			"NET_RT_FLAGS_PRIV":                 {"untyped int", constant.MakeInt64(int64(q.NET_RT_FLAGS_PRIV))},
			...
			"NL0":                               {"untyped int", constant.MakeInt64(int64(q.NL0))},
			"NL1":                               {"untyped int", constant.MakeInt64(int64(q.NL1))},
			"NL2":                               {"untyped int", constant.MakeInt64(int64(q.NL2))},
			"NL3":                               {"untyped int", constant.MakeInt64(int64(q.NL3))},
			"NLDLY":                             {"untyped int", constant.MakeInt64(int64(q.NLDLY))},
			...
			"NOTE_FUNLOCK":                      {"untyped int", constant.MakeInt64(int64(q.NOTE_FUNLOCK))},
			...
			"NOTE_MACHTIME":                     {"untyped int", constant.MakeInt64(int64(q.NOTE_MACHTIME))},
			"NOTE_MACH_CONTINUOUS_TIME":         {"untyped int", constant.MakeInt64(int64(q.NOTE_MACH_CONTINUOUS_TIME))},
			...
			"O_DP_GETRAWUNENCRYPTED":            {"untyped int", constant.MakeInt64(int64(q.O_DP_GETRAWUNENCRYPTED))},
			...
			"O_NOFOLLOW_ANY":                    {"untyped int", constant.MakeInt64(int64(q.O_NOFOLLOW_ANY))},
			...
			"RTF_DEAD":                          {"untyped int", constant.MakeInt64(int64(q.RTF_DEAD))},
			...
			"RTF_GLOBAL":                        {"untyped int", constant.MakeInt64(int64(q.RTF_GLOBAL))},
			...
			"RTF_NOIFREF":                       {"untyped int", constant.MakeInt64(int64(q.RTF_NOIFREF))},
			...
			"SHM_RDONLY":                        {"untyped int", constant.MakeInt64(int64(q.SHM_RDONLY))},
			"SHM_RND":                           {"untyped int", constant.MakeInt64(int64(q.SHM_RND))},
			...
			"SIOCGIF6LOWPAN":                    {"untyped int", constant.MakeInt64(int64(q.SIOCGIF6LOWPAN))},
			...
			"SIOCGIFFUNCTIONALTYPE":             {"untyped int", constant.MakeInt64(int64(q.SIOCGIFFUNCTIONALTYPE))},
			...
			"SIOCSIF6LOWPAN":                    {"untyped int", constant.MakeInt64(int64(q.SIOCSIF6LOWPAN))},
			...
			"SO_NETSVC_MARKING_LEVEL":           {"untyped int", constant.MakeInt64(int64(q.SO_NETSVC_MARKING_LEVEL))},
			"SO_NET_SERVICE_TYPE":               {"untyped int", constant.MakeInt64(int64(q.SO_NET_SERVICE_TYPE))},
			...
			"SO_TRACKER_ATTRIBUTE_FLAGS_APP_APPROVED": {"untyped int", constant.MakeInt64(int64(q.SO_TRACKER_ATTRIBUTE_FLAGS_APP_APPROVED))},
			"SO_TRACKER_ATTRIBUTE_FLAGS_DOMAIN_SHORT": {"untyped int", constant.MakeInt64(int64(q.SO_TRACKER_ATTRIBUTE_FLAGS_DOMAIN_SHORT))},
			"SO_TRACKER_ATTRIBUTE_FLAGS_TRACKER":      {"untyped int", constant.MakeInt64(int64(q.SO_TRACKER_ATTRIBUTE_FLAGS_TRACKER))},
			"SO_TRACKER_TRANSPARENCY_VERSION":         {"untyped int", constant.MakeInt64(int64(q.SO_TRACKER_TRANSPARENCY_VERSION))},
			...
			"SYS_ABORT_WITH_PAYLOAD":                  {"untyped int", constant.MakeInt64(int64(q.SYS_ABORT_WITH_PAYLOAD))},
			...
			"SYS_BSDTHREAD_CTL":                       {"untyped int", constant.MakeInt64(int64(q.SYS_BSDTHREAD_CTL))},
			...
			"SYS_CHANGE_FDGUARD_NP":                   {"untyped int", constant.MakeInt64(int64(q.SYS_CHANGE_FDGUARD_NP))},
			...
			"SYS_CLONEFILEAT":                         {"untyped int", constant.MakeInt64(int64(q.SYS_CLONEFILEAT))},
			...
			"SYS_COALITION":                           {"untyped int", constant.MakeInt64(int64(q.SYS_COALITION))},
			"SYS_COALITION_INFO":                      {"untyped int", constant.MakeInt64(int64(q.SYS_COALITION_INFO))},
			"SYS_CONNECT":                             {"untyped int", constant.MakeInt64(int64(q.SYS_CONNECT))},
			"SYS_CONNECTX":                            {"untyped int", constant.MakeInt64(int64(q.SYS_CONNECTX))},
			...
			"SYS_CSRCTL":                              {"untyped int", constant.MakeInt64(int64(q.SYS_CSRCTL))},
			"SYS_DELETE":                              {"untyped int", constant.MakeInt64(int64(q.SYS_DELETE))},
			"SYS_DISCONNECTX":                         {"untyped int", constant.MakeInt64(int64(q.SYS_DISCONNECTX))},
			...
			"SYS_FCLONEFILEAT":                        {"untyped int", constant.MakeInt64(int64(q.SYS_FCLONEFILEAT))},
			...
			"SYS_FMOUNT":                              {"untyped int", constant.MakeInt64(int64(q.SYS_FMOUNT))},
			...
			"SYS_FS_SNAPSHOT":                         {"untyped int", constant.MakeInt64(int64(q.SYS_FS_SNAPSHOT))},
			...
			"SYS_GETATTRLISTAT":                       {"untyped int", constant.MakeInt64(int64(q.SYS_GETATTRLISTAT))},
			"SYS_GETATTRLISTBULK":                     {"untyped int", constant.MakeInt64(int64(q.SYS_GETATTRLISTBULK))},
			...
			"SYS_GRAB_PGO_DATA":                       {"untyped int", constant.MakeInt64(int64(q.SYS_GRAB_PGO_DATA))},
			"SYS_GUARDED_CLOSE_NP":                    {"untyped int", constant.MakeInt64(int64(q.SYS_GUARDED_CLOSE_NP))},
			"SYS_GUARDED_KQUEUE_NP":                   {"untyped int", constant.MakeInt64(int64(q.SYS_GUARDED_KQUEUE_NP))},
			"SYS_GUARDED_OPEN_DPROTECTED_NP":          {"untyped int", constant.MakeInt64(int64(q.SYS_GUARDED_OPEN_DPROTECTED_NP))},
			"SYS_GUARDED_OPEN_NP":                     {"untyped int", constant.MakeInt64(int64(q.SYS_GUARDED_OPEN_NP))},
			"SYS_GUARDED_PWRITE_NP":                   {"untyped int", constant.MakeInt64(int64(q.SYS_GUARDED_PWRITE_NP))},
			"SYS_GUARDED_WRITEV_NP":                   {"untyped int", constant.MakeInt64(int64(q.SYS_GUARDED_WRITEV_NP))},
			"SYS_GUARDED_WRITE_NP":                    {"untyped int", constant.MakeInt64(int64(q.SYS_GUARDED_WRITE_NP))},
			...
			"SYS_INVALID":                             {"untyped int", constant.MakeInt64(int64(q.SYS_INVALID))},
			...
			"SYS_KDEBUG_TRACE64":                      {"untyped int", constant.MakeInt64(int64(q.SYS_KDEBUG_TRACE64))},
			"SYS_KDEBUG_TRACE_STRING":                 {"untyped int", constant.MakeInt64(int64(q.SYS_KDEBUG_TRACE_STRING))},
			"SYS_KDEBUG_TYPEFILTER":                   {"untyped int", constant.MakeInt64(int64(q.SYS_KDEBUG_TYPEFILTER))},
			...
			"SYS_KEVENT_ID":                           {"untyped int", constant.MakeInt64(int64(q.SYS_KEVENT_ID))},
			"SYS_KEVENT_QOS":                          {"untyped int", constant.MakeInt64(int64(q.SYS_KEVENT_QOS))},
			"SYS_KILL":                                {"untyped int", constant.MakeInt64(int64(q.SYS_KILL))},
			"SYS_KQUEUE":                              {"untyped int", constant.MakeInt64(int64(q.SYS_KQUEUE))},
			"SYS_KQUEUE_WORKLOOP_CTL":                 {"untyped int", constant.MakeInt64(int64(q.SYS_KQUEUE_WORKLOOP_CTL))},
			...
			"SYS_MEMORYSTATUS_CONTROL":                {"untyped int", constant.MakeInt64(int64(q.SYS_MEMORYSTATUS_CONTROL))},
			"SYS_MEMORYSTATUS_GET_LEVEL":              {"untyped int", constant.MakeInt64(int64(q.SYS_MEMORYSTATUS_GET_LEVEL))},
			"SYS_MICROSTACKSHOT":                      {"untyped int", constant.MakeInt64(int64(q.SYS_MICROSTACKSHOT))},
			...
			"SYS_MREMAP_ENCRYPTED":                    {"untyped int", constant.MakeInt64(int64(q.SYS_MREMAP_ENCRYPTED))},
			...
			"SYS_NECP_CLIENT_ACTION":                  {"untyped int", constant.MakeInt64(int64(q.SYS_NECP_CLIENT_ACTION))},
			"SYS_NECP_MATCH_POLICY":                   {"untyped int", constant.MakeInt64(int64(q.SYS_NECP_MATCH_POLICY))},
			"SYS_NECP_OPEN":                           {"untyped int", constant.MakeInt64(int64(q.SYS_NECP_OPEN))},
			"SYS_NECP_SESSION_ACTION":                 {"untyped int", constant.MakeInt64(int64(q.SYS_NECP_SESSION_ACTION))},
			"SYS_NECP_SESSION_OPEN":                   {"untyped int", constant.MakeInt64(int64(q.SYS_NECP_SESSION_OPEN))},
			"SYS_NETAGENT_TRIGGER":                    {"untyped int", constant.MakeInt64(int64(q.SYS_NETAGENT_TRIGGER))},
			"SYS_NET_QOS_GUIDELINE":                   {"untyped int", constant.MakeInt64(int64(q.SYS_NET_QOS_GUIDELINE))},
			...
			"SYS_OPENAT_NOCANCEL":                     {"untyped int", constant.MakeInt64(int64(q.SYS_OPENAT_NOCANCEL))},
			"SYS_OPENBYID_NP":                         {"untyped int", constant.MakeInt64(int64(q.SYS_OPENBYID_NP))},
			...
			"SYS_OS_FAULT_WITH_PAYLOAD":               {"untyped int", constant.MakeInt64(int64(q.SYS_OS_FAULT_WITH_PAYLOAD))},
			"SYS_PATHCONF":                            {"untyped int", constant.MakeInt64(int64(q.SYS_PATHCONF))},
			"SYS_PEELOFF":                             {"untyped int", constant.MakeInt64(int64(q.SYS_PEELOFF))},
			"SYS_PERSONA":                             {"untyped int", constant.MakeInt64(int64(q.SYS_PERSONA))},
			...
			"SYS_PROC_RLIMIT_CONTROL":                 {"untyped int", constant.MakeInt64(int64(q.SYS_PROC_RLIMIT_CONTROL))},
			"SYS_PROC_TRACE_LOG":                      {"untyped int", constant.MakeInt64(int64(q.SYS_PROC_TRACE_LOG))},
			"SYS_PROC_UUID_POLICY":                    {"untyped int", constant.MakeInt64(int64(q.SYS_PROC_UUID_POLICY))},
			"SYS_PSELECT":                             {"untyped int", constant.MakeInt64(int64(q.SYS_PSELECT))},
			"SYS_PSELECT_NOCANCEL":                    {"untyped int", constant.MakeInt64(int64(q.SYS_PSELECT_NOCANCEL))},
			...
			"SYS_RECVMSG_X":                           {"untyped int", constant.MakeInt64(int64(q.SYS_RECVMSG_X))},
			...
			"SYS_RENAMEATX_NP":                        {"untyped int", constant.MakeInt64(int64(q.SYS_RENAMEATX_NP))},
			...
			"SYS_SENDMSG_X":                           {"untyped int", constant.MakeInt64(int64(q.SYS_SENDMSG_X))},
			...
			"SYS_SETATTRLISTAT":                       {"untyped int", constant.MakeInt64(int64(q.SYS_SETATTRLISTAT))},
			...
			"SYS_SFI_CTL":                             {"untyped int", constant.MakeInt64(int64(q.SYS_SFI_CTL))},
			"SYS_SFI_PIDCTL":                          {"untyped int", constant.MakeInt64(int64(q.SYS_SFI_PIDCTL))},
			...
			"SYS_SOCKET_DELEGATE":                     {"untyped int", constant.MakeInt64(int64(q.SYS_SOCKET_DELEGATE))},
			"SYS_STACK_SNAPSHOT_WITH_CONFIG":          {"untyped int", constant.MakeInt64(int64(q.SYS_STACK_SNAPSHOT_WITH_CONFIG))},
			...
			"SYS_SYSCTLBYNAME":                        {"untyped int", constant.MakeInt64(int64(q.SYS_SYSCTLBYNAME))},
			"SYS_SYSTEM_OVERRIDE":                     {"untyped int", constant.MakeInt64(int64(q.SYS_SYSTEM_OVERRIDE))},
			"SYS_TELEMETRY":                           {"untyped int", constant.MakeInt64(int64(q.SYS_TELEMETRY))},
			"SYS_TERMINATE_WITH_PAYLOAD":              {"untyped int", constant.MakeInt64(int64(q.SYS_TERMINATE_WITH_PAYLOAD))},
			"SYS_THREAD_SELFCOUNTS":                   {"untyped int", constant.MakeInt64(int64(q.SYS_THREAD_SELFCOUNTS))},
			"SYS_THREAD_SELFID":                       {"untyped int", constant.MakeInt64(int64(q.SYS_THREAD_SELFID))},
			"SYS_THREAD_SELFUSAGE":                    {"untyped int", constant.MakeInt64(int64(q.SYS_THREAD_SELFUSAGE))},
			"SYS_TRUNCATE":                            {"untyped int", constant.MakeInt64(int64(q.SYS_TRUNCATE))},
			"SYS_ULOCK_WAIT":                          {"untyped int", constant.MakeInt64(int64(q.SYS_ULOCK_WAIT))},
			"SYS_ULOCK_WAKE":                          {"untyped int", constant.MakeInt64(int64(q.SYS_ULOCK_WAKE))},
			...
			"SYS_USRCTL":                              {"untyped int", constant.MakeInt64(int64(q.SYS_USRCTL))},
			"SYS_UTIMES":                              {"untyped int", constant.MakeInt64(int64(q.SYS_UTIMES))},
			"SYS_VFORK":                               {"untyped int", constant.MakeInt64(int64(q.SYS_VFORK))},
			"SYS_VFS_PURGE":                           {"untyped int", constant.MakeInt64(int64(q.SYS_VFS_PURGE))},
			...
			"SYS_WORK_INTERVAL_CTL":                   {"untyped int", constant.MakeInt64(int64(q.SYS_WORK_INTERVAL_CTL))},
			...
			"SYS___CHANNEL_GET_INFO":                  {"untyped int", constant.MakeInt64(int64(q.SYS___CHANNEL_GET_INFO))},
			"SYS___CHANNEL_GET_OPT":                   {"untyped int", constant.MakeInt64(int64(q.SYS___CHANNEL_GET_OPT))},
			"SYS___CHANNEL_OPEN":                      {"untyped int", constant.MakeInt64(int64(q.SYS___CHANNEL_OPEN))},
			"SYS___CHANNEL_SET_OPT":                   {"untyped int", constant.MakeInt64(int64(q.SYS___CHANNEL_SET_OPT))},
			"SYS___CHANNEL_SYNC":                      {"untyped int", constant.MakeInt64(int64(q.SYS___CHANNEL_SYNC))},
			"SYS___DISABLE_THREADSIGNAL":              {"untyped int", constant.MakeInt64(int64(q.SYS___DISABLE_THREADSIGNAL))},
			"SYS___MACH_BRIDGE_REMOTE_TIME":           {"untyped int", constant.MakeInt64(int64(q.SYS___MACH_BRIDGE_REMOTE_TIME))},
			...
			"SYS___NEXUS_CREATE":                      {"untyped int", constant.MakeInt64(int64(q.SYS___NEXUS_CREATE))},
			"SYS___NEXUS_DEREGISTER":                  {"untyped int", constant.MakeInt64(int64(q.SYS___NEXUS_DEREGISTER))},
			"SYS___NEXUS_DESTROY":                     {"untyped int", constant.MakeInt64(int64(q.SYS___NEXUS_DESTROY))},
			"SYS___NEXUS_GET_OPT":                     {"untyped int", constant.MakeInt64(int64(q.SYS___NEXUS_GET_OPT))},
			"SYS___NEXUS_OPEN":                        {"untyped int", constant.MakeInt64(int64(q.SYS___NEXUS_OPEN))},
			"SYS___NEXUS_REGISTER":                    {"untyped int", constant.MakeInt64(int64(q.SYS___NEXUS_REGISTER))},
			"SYS___NEXUS_SET_OPT":                     {"untyped int", constant.MakeInt64(int64(q.SYS___NEXUS_SET_OPT))},
			...
			"SizeofKinfoProc":                         {"untyped int", constant.MakeInt64(int64(q.SizeofKinfoProc))},
			...
			"SizeofSockaddrCtl":                       {"untyped int", constant.MakeInt64(int64(q.SizeofSockaddrCtl))},
			...
			"SizeofSockaddrVM":                        {"untyped int", constant.MakeInt64(int64(q.SizeofSockaddrVM))},
			"SizeofTCPConnectionInfo":                 {"untyped int", constant.MakeInt64(int64(q.SizeofTCPConnectionInfo))},
			"SizeofXSockbuf":                          {"untyped int", constant.MakeInt64(int64(q.SizeofXSockbuf))},
			"SizeofXSocket":                           {"untyped int", constant.MakeInt64(int64(q.SizeofXSocket))},
			"SizeofXVSockPgen":                        {"untyped int", constant.MakeInt64(int64(q.SizeofXVSockPgen))},
			"SizeofXucred":                            {"untyped int", constant.MakeInt64(int64(q.SizeofXucred))},
			"SizeofXvsockpcb":                         {"untyped int", constant.MakeInt64(int64(q.SizeofXvsockpcb))},
			"TAB0":                                    {"untyped int", constant.MakeInt64(int64(q.TAB0))},
			"TAB1":                                    {"untyped int", constant.MakeInt64(int64(q.TAB1))},
			"TAB2":                                    {"untyped int", constant.MakeInt64(int64(q.TAB2))},
			...
			"TCPOPT_CC":                               {"untyped int", constant.MakeInt64(int64(q.TCPOPT_CC))},
			"TCPOPT_CCECHO":                           {"untyped int", constant.MakeInt64(int64(q.TCPOPT_CCECHO))},
			"TCPOPT_CCNEW":                            {"untyped int", constant.MakeInt64(int64(q.TCPOPT_CCNEW))},
			"TCPOPT_EOL":                              {"untyped int", constant.MakeInt64(int64(q.TCPOPT_EOL))},
			"TCPOPT_FASTOPEN":                         {"untyped int", constant.MakeInt64(int64(q.TCPOPT_FASTOPEN))},
			...
			"TCPOPT_SACK_HDR":                         {"untyped int", constant.MakeInt64(int64(q.TCPOPT_SACK_HDR))},
			"TCPOPT_SACK_PERMITTED":                   {"untyped int", constant.MakeInt64(int64(q.TCPOPT_SACK_PERMITTED))},
			"TCPOPT_SACK_PERMIT_HDR":                  {"untyped int", constant.MakeInt64(int64(q.TCPOPT_SACK_PERMIT_HDR))},
			...
			"TCPOPT_TSTAMP_HDR":                       {"untyped int", constant.MakeInt64(int64(q.TCPOPT_TSTAMP_HDR))},
			...
			"TCP_CONNECTION_INFO":                     {"untyped int", constant.MakeInt64(int64(q.TCP_CONNECTION_INFO))},
			...
			"VMADDR_CID_ANY":                          {"untyped int", constant.MakeInt64(int64(q.VMADDR_CID_ANY))},
			"VMADDR_CID_HOST":                         {"untyped int", constant.MakeInt64(int64(q.VMADDR_CID_HOST))},
			"VMADDR_CID_HYPERVISOR":                   {"untyped int", constant.MakeInt64(int64(q.VMADDR_CID_HYPERVISOR))},
			"VMADDR_CID_RESERVED":                     {"untyped int", constant.MakeInt64(int64(q.VMADDR_CID_RESERVED))},
			"VMADDR_PORT_ANY":                         {"untyped int", constant.MakeInt64(int64(q.VMADDR_PORT_ANY))},
			"VMIN":                                    {"untyped int", constant.MakeInt64(int64(q.VMIN))},
			"VM_LOADAVG":                              {"untyped int", constant.MakeInt64(int64(q.VM_LOADAVG))},
			"VM_MACHFACTOR":                           {"untyped int", constant.MakeInt64(int64(q.VM_MACHFACTOR))},
			"VM_MAXID":                                {"untyped int", constant.MakeInt64(int64(q.VM_MAXID))},
			"VM_METER":                                {"untyped int", constant.MakeInt64(int64(q.VM_METER))},
			"VM_SWAPUSAGE":                            {"untyped int", constant.MakeInt64(int64(q.VM_SWAPUSAGE))},
			...
			"XATTR_CREATE":                            {"untyped int", constant.MakeInt64(int64(q.XATTR_CREATE))},
			"XATTR_NODEFAULT":                         {"untyped int", constant.MakeInt64(int64(q.XATTR_NODEFAULT))},
			"XATTR_NOFOLLOW":                          {"untyped int", constant.MakeInt64(int64(q.XATTR_NOFOLLOW))},
			"XATTR_NOSECURITY":                        {"untyped int", constant.MakeInt64(int64(q.XATTR_NOSECURITY))},
			"XATTR_REPLACE":                           {"untyped int", constant.MakeInt64(int64(q.XATTR_REPLACE))},
			"XATTR_SHOWCOMPRESSION":                   {"untyped int", constant.MakeInt64(int64(q.XATTR_SHOWCOMPRESSION))},
